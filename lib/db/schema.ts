...
export const taskEvaluations = sqliteTable(
  "task_evaluations",
  {
    ...
    qualityPass: integer("quality_pass", { mode: "boolean" }).notNull().default(false),
    validityPass: integer("validity_pass", { mode: "boolean" }).notNull().default(false),
    validityBlockedReasonsJson: text("validity_blocked_reasons_json").notNull().default("[]"),
